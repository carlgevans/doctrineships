namespace DoctrineShips.Entities
{
    ...
    public class ShipFit : EntityBase
    {
        ...
        /// </summary>
        private static Dictionary<SlotType, string> slotToXmlStrings = new Dictionary<SlotType, string>();
        /// <summary>
        ...
        private void InitializeXmlDictionaries()
        {
            if (slotToXmlStrings.Count == 0)
            {
        ...
        public string ToXML
        {
            get
            {
                ...
                if (ShipFitComponents == null) return string.Empty;
